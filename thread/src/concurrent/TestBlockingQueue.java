...
public class TestBlockingQueue {
	 ...
	 * 前者将一个对象放到队列中，如果队列已经满了，就等待直到有空闲节点；后者从head取一个对象，如果没有对象，就等待直到有可取的对象。
	 * 
	...
	public static void main(String[] args) {
		...
		final File root = new File("E:\\workspace\\thread");
		// 完成标志
			...
			public void scanFile(File file) {
				...
				if (file.isDirectory()) {
					...
					try {
						...
						System.out.println("Read0: " + index + " " + "file.getPath() :" + file.getPath());
						queue.put(file);
